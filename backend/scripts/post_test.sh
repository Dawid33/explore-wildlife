...
species_name="Bluebird"
post_image_id="87534c64-f093-4a1e-9584-cfade9263988"
...
curl -v -X POST -F "post_title=$post_title" -F "post_description=$post_description" -F "post_latitude=$post_latitude" -F "post_longitude=$post_longitude" -F "post_image_id=$created_by" -F "created_by=$created_by" -F "post_category=$post_category" -F "species_name=$species_name"  http://127.0.0.1:8080/$path_create_post
